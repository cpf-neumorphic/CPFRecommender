...
col1.write(f"age: {barbra_age}")
col2.write(f"income: {barbra_martin_features[barbra_age][0]}")
col3.write(f"children: {barbra_martin_features[barbra_age][1]}")
...
col2.write("2nd Recommendation : ")
col2.image(Image.open(f"img/{rec2}.png"), use_column_width=True)
col3.write("3rd Recommendation : ")
